...
DROP TABLE IF EXISTS `control_consecutivos`;
...
CREATE TABLE `control_consecutivos` (
  ...
  CONSTRAINT `control_consecutivos_ibfk_1` FOREIGN KEY (`id_tipo_documento`) REFERENCES `tipos_documentos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `control_consecutivos`
--
