...
CREATE TABLE `tipos_documentos` (
  ...
  `requiere_juridica` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
...
INSERT INTO `tipos_documentos` VALUES (1,'Circular Normativa','C-N',0),(2,'Circular Informativa','C-I',0),(3,'Resolucion','RES',1);
